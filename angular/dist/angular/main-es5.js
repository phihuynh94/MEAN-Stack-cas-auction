...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/components/admin/add-user/add-user.component.html":
  /*!*********************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/components/admin/add-user/add-user.component.html ***!
    \*********************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsAdminAddUserAddUserComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsAuctionsItemListItemListComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div class=\"d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-3 mb-3 border-bottom\">\n    <h2>Inventory:</h2>\n\n    <div *ngIf=\"userDetails.type == 'staff'\">\n      <button type=\"button\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#defineOrderModal\">\n        <img src=\"../../../assets/icons/list.svg\">\n        Define Order\n      </button>\n    </div>\n\n    <div class=\"btn-toolbar mb-2 mb-md-0\">\n      <div class=\"btn-group mr-2\">\n        <!--Refresh button-->\n        <button (click)=\"refresh()\" class=\"btn-refresh\">\n          <img src=\"../../../assets/icons/refresh-cw.svg\">\n          Refresh</button>\n      </div>\n    </div>\n</div>\n\n<h4 class=\"text-center\">Auction Items:</h4>\n<!--Display auction items in a card container-->\n<div class=\"card-container border-bottom mb-3 pb-3\">\n  <!--Display each auction items in the list-->\n  <div class=\"card\" *ngFor=\"let aucItem of auctionItems\" routerLink=\"/itemPage/{{ aucItem._id }}\">\n    <img src=\"../../../assets/auction-fish.jpeg\" class=\"card-img\" >\n    <h5><b>{{ aucItem.itemName }}</b></h5>\n    <p>Qty: {{ aucItem.quantity }}</p>\n    <p>Code: {{ aucItem.itemCode }}</p>\n    <p>Type: {{ aucItem.type }}</p>\n  </div>\n</div>\n\n<h4 class=\"text-center\">Quick Sell Items:</h4>\n<!--Display quick sell items in a card container-->\n<div class=\"card-container border-bottom mb-3 pb-3\">\n  <!--Display each quick sell items in the list-->\n  <div class=\"card\" *ngFor=\"let quickSellItem of quickSellItems\" routerLink=\"/itemPage/{{ quickSellItem._id }}\">\n    <img src=\"../../../assets/auction-fish.jpeg\" class=\"card-img\" >\n    <h5><b>{{ quickSellItem.itemName }}</b></h5>\n    <p>Qty: {{ quickSellItem.quantity }}</p>\n    <p>Code: {{ quickSellItem.itemCode }}</p>\n    <p>Type: {{ quickSellItem.type }}</p>\n    <p>Price: {{ quickSellItem.price | currency }}</p>\n  </div>\n</div>\n\n<h4 class=\"text-center\">My Selling Items:</h4>\n<!--Display seller items in a card container-->\n<div class=\"card-container mb-3 pb-3\">\n  <!--Display each seller items in the list-->\n  <div class=\"card\" *ngFor=\"let sellerItem of sellerItems\" routerLink=\"/itemPage/{{ sellerItem._id }}\">\n    <img src=\"../../../assets/auction-fish.jpeg\" class=\"card-img\" >\n    <h5><b>{{ sellerItem.itemName }}</b></h5>\n    <p>Qty: {{ sellerItem.quantity }}</p>\n    <p>Code: {{ sellerItem.itemCode }}</p>\n    <p>Type: {{ sellerItem.type }}</p>\n  </div>\n</div>\n\n<div class=\"modal fade\" id=\"defineOrderModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"defineOrderModal\" aria-hidden=\"true\">        \n  <div class=\"modal-dialog\" role=\"document\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <h5 class=\"modal-title\">Define Order</h5>\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n          <span aria-hidden=\"true\">&times;</span>\n        </button>\n      </div>\n\n      <div class=\"modal-body\">\n        <!-- <select id=\"itemCode\" name=\"itemCode\" #itemCode=\"ngModel\" [(ngModel)]=\"aucItem.itemCode\" class=\"form-control\">\n          <option value=\"auction\">Auction</option>\n          <option value=\"quick sell\">Quick Sell</option>\n        </select> -->\n\n        <div *ngFor=\"let aucItem of auctionItems\">\n          <p>{{ aucItem.itemCode }}</p>\n        </div>\n      </div>\n    </div> \n  </div>\n</div>";
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_auctions_participants_list_participants_list_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
    ...
    var _components_auctions_live_auction_live_auction_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
    ...
    var _components_dashboard_cart_check_out_check_out_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
    ...
    var _components_user_user_profile_user_profile_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
    /*! ./components/user/user-profile/user-profile.component */
    "./src/app/components/user/user-profile/user-profile.component.ts");
    /* harmony import */


    var _components_user_forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(
    ...
    var _components_auctions_item_page_item_page_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(
    /*! ./components/auctions/item-page/item-page.component */
    "./src/app/components/auctions/item-page/item-page.component.ts");
    /* harmony import */


    var _components_user_reset_password_reset_password_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(
    ...
    var _components_admin_view_users_view_users_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(
    /*! ./components/admin/view-users/view-users.component */
    "./src/app/components/admin/view-users/view-users.component.ts");
    /* harmony import */


    var _components_admin_add_user_add_user_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(
    /*! ./components/admin/add-user/add-user.component */
    "./src/app/components/admin/add-user/add-user.component.ts"); // built in library
    // components
    // routes
    ...
    }, // url: 'user/forgotPassword'
    {
      ...
      children: [{
        path: 'forgotPassword',
        component: _components_user_forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_27__["ForgotPasswordComponent"]
      }]
    }, {
      path: 'user',
      component: _components_user_user_component__WEBPACK_IMPORTED_MODULE_8__["UserComponent"],
      children: [{
        ...
        component: _components_user_reset_password_reset_password_component__WEBPACK_IMPORTED_MODULE_29__["ResetPasswordComponent"]
      }]
    }, // url: 'user-profile'
    {
      path: 'user-profile',
      component: _components_user_user_profile_user_profile_component__WEBPACK_IMPORTED_MODULE_26__["UserProfileComponent"]
    }, // url: 'dashboard'
    {
      path: 'dashboard',
    ...
    {
      path: 'live/:id',
      component: _components_auctions_live_auction_live_auction_component__WEBPACK_IMPORTED_MODULE_24__["LiveAuctionComponent"]
    }, // url: 'cart'
    {
      path: 'cart',
    ...
    {
      path: 'checkout',
      component: _components_dashboard_cart_check_out_check_out_component__WEBPACK_IMPORTED_MODULE_25__["CheckOutComponent"]
    }, // url: 'item-page'
    {
      path: 'itemPage/:id',
      component: _components_auctions_item_page_item_page_component__WEBPACK_IMPORTED_MODULE_28__["ItemPageComponent"]
    }, // url: 'view-users'
    {
      path: 'viewUsers',
      component: _components_admin_view_users_view_users_component__WEBPACK_IMPORTED_MODULE_30__["ViewUsersComponent"]
    }];
  ...
  /***/
  function srcAppComponentsAdminAddUserAddUserComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvYWRtaW4vYWRkLXVzZXIvYWRkLXVzZXIuY29tcG9uZW50LmNzcyJ9 */";
    /***/
  },
  ...
  /***/
  function srcAppComponentsAdminAddUserAddUserComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      function AddUserComponent(userService) {
        ...
        this.user = new _user_model_user_model__WEBPACK_IMPORTED_MODULE_3__["User"]();
      }
    ...
    AddUserComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/admin/add-user/add-user.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./add-user.component.css */
      "./src/app/components/admin/add-user/add-user.component.css")).default]
    })], AddUserComponent);
    /***/
  },
    ...
    function () {
      ...
      _createClass(AdminComponent, [{
        ...
        value: function isStaff() {
          if (this.userDetails.type == 'staff') this.staff = true;else this.router.navigate(['/dashboard']);
        }
      }]);
  ...
  function srcAppComponentsAdminCreateAuctionCreateAuctionComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _model_auction_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../model/auction.model */
    ...
    function () {
      function CreateAuctionComponent(auctionService) {
        ...
        this.auction = new _model_auction_model__WEBPACK_IMPORTED_MODULE_2__["Auction"]();
        this.numRegex = /^[1-9][0-9]*$/;
        this.currencyRegex = /^\$?(([1-9](\d*|\d{0,2}(,\d{3})*))|0)(\.\d{1,2})?$/;
      }
  ...
  function srcAppComponentsAdminViewUsersViewUsersComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function ViewUsersComponent(userService, location, router) {
        _classCallCheck(this, ViewUsersComponent);

        this.userService = userService;
        this.location = location;
        this.router = router;
        this.editUser = new _user_model_user_model__WEBPACK_IMPORTED_MODULE_5__["User"]();
        this.aliasRegex = /[A-Za-z]{3}/;
      ...
      _createClass(ViewUsersComponent, [{
        ...
        value: function onEditUserSubmit(form) {
          ...
          this.userService.editUser(form.value).subscribe(function (res) {
            _this7.showSucessMessage = true;
            setTimeout(function () {
              return _this7.showSucessMessage = false;
            }, 4000);
          }, function (err) {
            if (err.status === 422) {
              _this7.serverErrorMessages = err.error.join('<br/>');
            } else _this7.serverErrorMessages = 'Something went wrong.Please contact admin.';
          });
        }
      }, {
        key: "getUser",
  ...
  function srcAppComponentsAuctionsAddItemAddItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _model_item_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../model/item.model */
    ...
    var _service_auction_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../../service/auction.service */
    "./src/app/components/service/auction.service.ts");
    /* harmony import */


    var _model_auction_model__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../../model/auction.model */
    ...
    function () {
      function AddItemComponent(itemService, route, userService, auctionService) {
        ...
        this.auctionDetails = new _model_auction_model__WEBPACK_IMPORTED_MODULE_8__["Auction"]();
        this.item = new _model_item_model__WEBPACK_IMPORTED_MODULE_3__["Item"]();
        this.numRegex = /^[1-9][0-9]*$/;
        this.currencyRegex = /^\$?(([1-9](\d*|\d{0,2}(,\d{3})*))|0)(\.\d{1,2})?$/;
      ...
      _createClass(AddItemComponent, [{
        ...
        value: function onSubmit(form) {
          ...
          if (this.imagesToUpload) {
            ...
            try {
              for (var _iterator = this.imagesToUpload[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var img = _step.value;
          ...
          this.itemService.addItem(this.item).subscribe(function (res) {
            if (_this10.imagesToUpload) {
              _this10.itemService.uploadImages(_this10.formData).subscribe();
            }

            _this10.showSucessMessage = true;
            setTimeout(function () {
              return _this10.showSucessMessage = false;
            }, 4000);
            ...
            } else _this10.serverErrorMessages = err.error.text;

            _this10.code = _this10.item.itemCode.substring(3, 6);
          });
        }
      }, {
        key: "resetForm",
          ...
          if (image.files) {
            ...
            for (var i = 0; i < this.imagesToUpload.length; i++) {
              ...
              reader.onload = function (event) {
                _this13.imgSrc.push(event.target.result);
              };
    ...
    AddItemComponent.ctorParameters = function () {
      return [{
        ...
        type: _service_auction_service__WEBPACK_IMPORTED_MODULE_7__["AuctionService"]
      }];
    };
  ...
  function srcAppComponentsAuctionsAuctionEditAuctionEditComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function AuctionEditComponent(auctionService, route, router, location, userService) {
      ...
      _createClass(AuctionEditComponent, [{
        ...
        value: function onSubmit(form) {
          ...
          this.auctionService.editAuction(form.value).subscribe(function (res) {
            _this15.showSucessMessage = true;
            setTimeout(function () {
              return _this15.showSucessMessage = false;
            }, 4000);
            _this15.serverErrorMessages = '';
          }, function (err) {
            _this15.serverErrorMessages = err.error.text;
          });
        }
      }, {
        key: "deleteAuction",
  ...
  function srcAppComponentsAuctionsItemListItemListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function ItemListComponent(itemService, route, userService) {
        ...
        this.userService = userService;
        this.auctionID = this.route.snapshot.paramMap.get('id');
        this.sellerDetails = new _user_model_user_model__WEBPACK_IMPORTED_MODULE_6__["User"]();
      ...
      _createClass(ItemListComponent, [{
        ...
        value: function getItems() {
          ...
          this.itemService.getItemsInAuction(this.auctionID).subscribe(function (res) {
            _this23.itemInfo = res; // split auction and quicksell into 2 array

            for (var i = 0; i < _this23.itemInfo.length; i++) {
              if (_this23.itemInfo[i].type == 'auction') {
                _this23.auctionItems.push(_this23.itemInfo[i]);
              } else {
        ...
        value: function getSeller() {
          ...
          this.userService.getUserProfile().subscribe(function (res) {
            _this24.sellerDetails = res['user'];

            _this24.getSellerItems();
          });
        }
      }, {
        key: "getSellerItems",
  ...
  function srcAppComponentsAuctionsItemPageItemPageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function ItemPageComponent(route, itemService, userService, location) {
        ...
        this.aliasRegex = /[A-Za-z]{3}/;
        this.currencyRegex = /^\$?(([1-9](\d*|\d{0,2}(,\d{3})*))|0)(\.\d{1,2})?$/;
        this.buyerDetails = new _user_model_user_model__WEBPACK_IMPORTED_MODULE_7__["User"]();
      }
      ...
      _createClass(ItemPageComponent, [{
        ...
        value: function getItemInfo() {
          ...
          this.itemService.getItemInfoById(this.itemID).subscribe(function (res) {
            _this27.itemInfo = res;
            _this27.code = _this27.itemInfo.itemCode[3];

            _this27.getSellerInfo();
          });
        }
      }, {
        key: "getSellerInfo",
        ...
        value: function onEditItemSubmit(form) {
          ...
          this.itemService.editItem(form.value).subscribe(function (res) {
            _this29.showSucessMessage = true;
            setTimeout(function () {
              return _this29.showSucessMessage = false;
            }, 4000);
            _this29.serverErrorMessages = '';
          }, function (err) {
            _this29.serverErrorMessages = 'Duplicate item code.';
          });
        }
      }, {
        key: "onDeleteItem",
        ...
        key: "onQuickSellSubmit",
        value: function onQuickSellSubmit(form) {
          var _this32 = this;

          this.userService.getUserByAlias(form.value.alias).subscribe(function (res) {
            _this32.buyerDetails = res;

            if (_this32.buyerDetails == null) {
              _this32.quickSellErrorMessage = 'No user with this alias found.';
              setTimeout(function () {
                return _this32.quickSellErrorMessage = '';
              }, 4000);
            } else {
              _this32.itemInfo.buyerID = _this32.buyerDetails._id;

              _this32.itemService.editItem(_this32.itemInfo).subscribe(function (res) {
                _this32.quickSellSuccessMessage = true;
                setTimeout(function () {
                  return _this32.quickSellSuccessMessage = false;
                }, 4000);
                _this32.quickSellErrorMessage = '';
              });
            }
          });
        }
  ...
  function srcAppComponentsAuctionsLiveAuctionLiveAuctionComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _user_service_user_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../../user/service/user.service */
    ...
    /*#__PURE__*/
    function () {
      function LiveAuctionComponent(route, auctionService, itemService, userService, router) {
      ...
      _createClass(LiveAuctionComponent, [{
        ...
        value: function onSubmit() {
          ...
          if (this.winnerNum > this.participants.length) {
            ...
            this.itemService.editItem(this.items[this.i]).subscribe(function (res) {
              _this36.successMessage = 'Sold.';
              _this36.errorMessage = '';
            });
          }
        }
      }, {
    ...
    LiveAuctionComponent.ctorParameters = function () {
      return [{
        ...
        type: _user_service_user_service__WEBPACK_IMPORTED_MODULE_7__["UserService"]
      }, {
        type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]
      }];
    };
    ...
    function () {
      ...
      _createClass(CartComponent, [{
        ...
        value: function getUser() {
          ...
          this.userService.getUserProfile().subscribe(function (res) {
            _this40.userDetails = res['user'];

            _this40.getBuyerItems();
          });
        }
      }, {
        key: "getBuyerItems",
        value: function getBuyerItems() {
          ...
          this.itemService.getBuyerItems(this.userDetails._id).subscribe(function (res) {
            ...
            for (var i in _this41.items) {
              _this41.totalAmount = _this41.totalAmount + _this41.items[i].price;
            }
          });
        }
      }]);
  ...
  function srcAppComponentsHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"])('document:click', ['$event.target'])], HomeComponent.prototype, "onClick", null);
  ...
  function srcAppComponentsServiceItemServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(ItemService, [{
        ...
        key: "uploadImages",
        value: function uploadImages(images) {
          return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].itemUrl + '/uploadImages', images);
        }
      }, {
        ...
        key: "defineOrder",
        value: function defineOrder(order) {
          return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].itemUrl + '/defineOrder', {
            order: order
          });
        }
      }]);
      ...
      _createClass(ForgotPasswordComponent, [{
        ...
        value: function onSubmit(form) {
          ...
          this.userService.forgotPassword(form.value).subscribe(function (res) {
            _this43.showSucessMessage = true;
            setTimeout(function () {
              return _this43.showSucessMessage = false;
            }, 4000);
          }, function (err) {
            _this43.serverErrorMessages = err.error.message;
            setTimeout(function () {
              return _this43.serverErrorMessages = '';
            }, 4000);
          });
        }
      }]);
        ...
        value: function onSubmit(form) {
          ...
          if (form.value.newPassword == form.value.confirmPassword) {
            this.userService.resetPassword(this.token, form.value.newPassword).subscribe(function (res) {
              ...
              setTimeout(function () {
                return _this44.router.navigateByUrl('/user/signin');
              }, 4000);
            }, function (err) {
              _this44.serverErrorMessages = 'This reset password link is not working.';
            });
          } else {
    ...
    function () {
      ...
      _createClass(UserService, [{
        ...
        value: function deleteUser(id) {
          return this.http.delete(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].userUrl + '/deleteUser/' + id);
        }
      }, {
        key: "getUserByAlias",
        value: function getUserByAlias(alias) {
          return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].userUrl + '/getUserByAlias/' + alias);
        } // Helper Methods
      ...
      _createClass(SignInComponent, [{
        ...
        value: function onSubmit(form) {
          ...
          this.userService.login(form.value).subscribe(function (res) {
            _this45.userService.setToken(res['token']);

            _this45.router.navigateByUrl('/dashboard');
          }, function (err) {
            _this45.serverErrorMessages = err.error.message;
          });
        }
      }]);
  ...
  function srcAppComponentsUserSignUpSignUpComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _model_user_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../model/user.model */
    "./src/app/components/user/model/user.model.ts"); // get built-in
    // get components
    ...
    function () {
      function SignUpComponent(userService, router) {
        ...
        this.emailRegex = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
        this.aliasRegex = /[A-Za-z]{3}/;
        this.user = new _model_user_model__WEBPACK_IMPORTED_MODULE_4__["User"]();
      }
      ...
      _createClass(SignUpComponent, [{
        ...
        value: function onSubmit(form) {
          ...
          this.userService.addUser(form.value).subscribe(function (res) {
            _this46.showSucessMessage = true;
            setTimeout(function () {
              return _this46.showSucessMessage = false;
            }, 2000);

            _this46.resetForm(form);

            setTimeout(function () {
              return _this46.router.navigateByUrl('/user/signin');
            }, 2000);
          }, function (err) {
            if (err.status === 422) {
              _this46.serverErrorMessages = err.error.join('<br/>');
            } else _this46.serverErrorMessages = err.error.text;
          });
        } // Reset form function
    ...
    function () {
      ...
      _createClass(UserProfileComponent, [{
        ...
        value: function onEditProfileSubmit(form) {
          ...
          this.userService.editUser(form.value).subscribe(function (res) {
            _this48.showSucessMessage = true;
            setTimeout(function () {
              return _this48.showSucessMessage = false;
            }, 4000);
            _this48.serverErrorMessages = '';
          }, function (err) {
            _this48.serverErrorMessages = err.error.text;
          });
        }
      }, {
        ...
        value: function changePasswordSubmit(form) {
          ...
          this.userService.login(form.value).subscribe(function (res) {
            _this49.userService.changePassword(res, _this49.newPassword).subscribe(function (res) {
              _this49.showSucessMessage2 = true;
              setTimeout(function () {
                return _this49.showSucessMessage2 = false;
              }, 4000);
            }, function (err) {});
          }, function (err) {
            if (err.status === 404) {
              _this49.serverErrorMessages2 = 'Wrong password';
              setTimeout(function () {
                return _this49.serverErrorMessages2 = '';
              }, 4000);
            } else _this49.serverErrorMessages2 = 'Something went wrong.Please contact admin.';
          });
        }
      }]);
